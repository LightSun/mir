...
MIR_item_t create_mir_func_with_loop (MIR_context_t ctx, MIR_module_t *m) {
  ...
  MIR_reg_t ARG1, R2;
  MIR_type_t res_type;//return type
  ...
  fin = MIR_new_label (ctx);  //L1
  cont = MIR_new_label (ctx); //L2

  //define  whole of func
  /*
loop:   func    i64, i64:arg1
        local   i64:count, i64:t1
# 1 arg, 2 locals
        mov     count, 0
        bge     L1, count, arg1
*/
